...
<body>
    <div class="container">
      ...
      <?php  } ?>
        <form action="?mod=employee&act=store" id="formid" class="container" method="POST">
        ...
        <div class="row">
            <div class="col-sm-9">
                <div class="form-group">
                    <h5>Mã Nhân Viên</h5>
                    <input type="text" class="form-control" name="code" placeholder="Mã Nhân Viên" required="">
                </div>
            </div>
            <div class="col-sm-9">
                <div class="form-group">
        ...
        <div class="">
            <input type="submit" value="Thêm sinh viên" class="btn-submit btn-primary">
