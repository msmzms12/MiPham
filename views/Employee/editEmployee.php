...
<body>
    <div class="container">
      ...
      <?php  } ?>
        <form action="?mod=employee&act=update" id="formid" class="container" method="POST">
        <a href="?mod=employee&act=list" class="btn btn-primary">Back</a>    
        ...
        <div class="row">
            <div class="col-sm-9">
                <div class="form-group">
                    <h5>Mã Nhân Viên</h5>
                    <input type="text" class="form-control" name="code" placeholder="Mã Nhân Viên" required="" value="<?= $result['code']?>" readonly>
                </div>
            </div>
            <div class="col-sm-9">
                <div class="form-group">
                    <h5>Tên Nhân Viên</h5>
                    <input type="text" class="form-control" name="name" placeholder="Tên Nhân Viên" required="" value="<?= $result['name']?>">
                </div>
            </div>
            <div class="col-sm-9">
                <div class="form-group">
                    <h5>Ngày Sinh</h5>
                    <input type="date" class="form-control" name="birthday" placeholder="Ngày Sinh" required="" value="<?= $result['birthday']?>">
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="">
            <input type="submit" value="Sửa sinh viên" class="btn-submit btn-primary">
