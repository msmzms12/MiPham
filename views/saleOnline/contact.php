          ...
          <div class="nav2">
           <div id="pt_custommenu" class="pt_custommenu">
             <div id="pt_menu_home" class="pt_menu"><div class="parentMenu"><a href="index.php?route=common/home"><span>Home</span></a></div></div><div id="pt_menu57" class="pt_menu nav-1">
              ...
              <div class="parentMenu">
                <a href="index.php?route=product/category&amp;path=24">
                  <span>Contact</span>
                </a>
              </div>
            </div>			</div>
...
<script type="text/javascript">
  ...
  <ul class="breadcrumb">
    ...
    <li><a href="index.php?route=checkout/cart">Contact</a></li>
  </ul>
  <div class="row">                
    <div id="content" class="col-sm-12">      
      <h1>Contact</h1>
      <form action="?mod=saleOnline&act=contactadd" method="POST" >
        <div class="table-responsive table-checkout-cart">
          <div id="frm_subscribe">
              ...
              ">Name</h3>
              <input type="text" value="<?=$kh['name'] ?>" name="name" id="subscribe_email" placeholder="Name..." style="color: black">
              <h3 class="chu" style="
              font-size: 16px;
              margin: 10 0 15px;
              color: #666666;
              ...
              letter-spacing: 0.1em;
              ">Email</h3>
              <input type="text" value="<?=$kh['email'] ?>" name="email" id="subscribe_email" placeholder="Email..."style="color: black"/>
              ...
              letter-spacing: 0.1em;
              ">Mobile</h3>
              <input type="text" value="<?=$kh['mobile'] ?>" name="moblie" id="subscribe_email" placeholder="Mobile..."style="color: black"/>
              <h3 class="chu" style="
              font-size: 16px;
              margin: 10 0 15px;
              color: #666666;
              ...
              letter-spacing: 0.1em;
              ">Content</h3>
              <input type="" value="" name="content" id="subscribe_email" placeholder="Content..."style="color: black"/>
        ...
        <div class="row"> 
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="checkout-cart-buttons">
              ...
              <div class="button-update-cart"><button type="submit" title="Send" class="btn btn-primary">SEND</button></div>
