...
<script type="text/javascript">
  ...
  <ul class="breadcrumb">
    ...
    <li><a href="index.php?route=checkout/cart">Information Order</a></li>
  </ul>
  <div class="row">                
    <div id="content" class="col-sm-12">      
      <h1>Information Order</h1>
      <form action="?mod=saleOnline&act=send_email" method="POST" >
        <div class="table-responsive table-checkout-cart">
          <div id="frm_subscribe">
              ...
              letter-spacing: 0.1em;
              ">Address</h3>
              <input type="text" value="<?=$kh['address'] ?>" name="addres" id="subscribe_email" placeholder="Address..."style="color: black"/>
              <h3 class="chu" style="
              font-size: 16px;
              margin: 10 0 15px;
              color: #666666;
        ...
        <div class="row"> 
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="checkout-cart-buttons">
              ...
              <div class="button-update-cart"><button type="submit" title="Update" class="btn btn-primary">Continue Order</button></div>
